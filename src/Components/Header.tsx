...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-50">
      ...
      >
        <ul className="flex space-x-2 sm:space-x-12 cursor-pointer">
          <li className="footer_link font-semibold hover:scale-110 hover:skew-y-2" onClick={() => handleNavigate("/")}>
            {isLoading ? <Spinner /> : null}
            <Link to="/">Home</Link>
          </li>
          <li className="footer_link font-semibold hover:scale-110 hover:skew-y-2" onClick={() => handleNavigate("/cookies")}>
            {isLoading ? <Spinner /> : null}
            <Link to="/cookies">Cookies</Link>
          </li>
          <li className="footer_link font-semibold hover:scale-110 hover:skew-y-2" onClick={() => handleNavigate("/cakes")}>
            {isLoading ? <Spinner /> : null}
            <Link to="/cakes">Cakes</Link>
          </li>
          <li className="footer_link font-semibold hover:scale-110 hover:skew-y-2" onClick={() => handleNavigate("/blog")}>
            {isLoading ? <Spinner /> : null}
            <Link to="/blog">Recipe</Link>
          </li>
        </ul>
